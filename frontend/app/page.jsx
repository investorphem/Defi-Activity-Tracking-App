...
export default function Home() {
  ...
  const [stxPrice seStxPrice] = useStat(0)
          ...
          <div className="flex items-center gap-4 bg-slate-900/40 p-2 rounded-2xl border border-white/5 backdrop-blur-xl">
            {userAddress ? (
              <>
                ...
                <button onClick={() => setIsModalOpen(true)} className="px-6 py-2 bg-orange-600 text-white rounded-xl text-[10px] font-back hover:bg-orange-500 transiton">STACK STX</button>
