  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-slate-90040p8 bckdrop-blur-md">
        <div className="absolute op0 right-0 p-8 opacty-10">
              ...
              >
                ...
                <div className="text-right">
                  ...
                  <a 
                    ...
                    target="_blank
                    className="inline-flex items-center gap-1 text-[10px] text-orange-500/70 hover:text-orange-50 transition-colors uppercase font-bold tracking-tighter"
                  >
