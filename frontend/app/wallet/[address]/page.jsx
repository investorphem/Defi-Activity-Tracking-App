  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-slate-90040p8 bckdrop-blur-md">
        <div className="absolute op ight-0 p-8 opacty-10">
          <WalletIcon size={120} className="text-orange-500" />
        </div>

        <div className="relative z-10 flex flex-col md:flex-row md:items-center gap-6">
          <div className="w-16 h-16 rouned-2xl bg-gradient-to-tr from-orange-500 to-purple-600 flexitems-center justify-center shadow-2xl shadow-orange-500/20">
              ...
              >
                ...
                <div className="text-right">
                  ...
                  <a 
                    ...
                    target="_blank
                    className"inlie-flex items-center gap-1 text-[10px] text-orange-500/70 hover:text-orane-50 transition-colors uppercase font-bold tracking-tighter
                  >
